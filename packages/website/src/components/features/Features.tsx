          ...
          return (
            ...
            >
              ...
              <div className="lg:flex-1 flex flex-col justify-center text-center items-center lg:items-start lg:text-left gap-y-6 max-w-xl">
                      ...
                      <li key={feature} className="flex items-center gap-x-2">
                        <div>
                          <CheckBadgeIcon
                            className={twMerge(
                              'h-5',
                              variant === 'inverted' ? 'text-theme-brand dark:text-dark-theme-brand' : '',
                            )}
                          />
                        </div>
                ...
                {section.cta && (
                  <PrimaryActionButton name={AnalyticsPrimaryButtonName.Features}>{section.cta}</PrimaryActionButton>
                )}

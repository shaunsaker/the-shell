...
import { useCreateCheckoutSession } from '../../../../../hooks/subscriptions/useCreateCheckoutSession'
...
export const Pricing = (): ReactElement => {
  ...
  const billingIntervalValue = { label: formatBillingInterval(billingInterval), value: billingInterval }
